    ...
    <main className="flex flex-col items-center justify-center mt-20">
      ...
      <div className="w-full max-w-6xl p-8">
        ...
        <div className="prose lg:prose-xl">
          ...
          <p>
            ZapStream (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;)
            operates the https://jj-ZapStream.vercel.app website (hereinafter
          ...
          <p>
            Service is the https://jj-ZapStream.vercel.app website operated by
            ZapStream.
          </p>
          ...
          <p>ZapStream uses the collected data for various purposes:</p>
          <ul className="list-disc list-inside">
          ...
          <p>
            If you are from the European Economic Area (EEA), ZapStream&apos;s
            ...
            collect and the specific context in which we collect it. ZapStream
          ...
          <p>
            ZapStream will retain your Personal Data only for as long as is
            necessary for the purposes set out in this Privacy Policy. We will
            retain and use your Personal Data to the extent necessary to comply
            with our legal obligations (for example, if we are required to
            retain your data to comply with applicable laws), resolve disputes,
            and enforce our legal agreements and policies. ZapStream will also
          ...
          <p>
            ...
            agreement to that transfer. ZapStream will take all the steps
          ...
          <p>
            ZapStream may disclose your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul className="list-disc list-inside">
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of ZapStream</li>
            <li>
          ...
          <p>
            ...
            certain data protection rights. ZapStream aims to take reasonable
          ...
          <ul className="list-disc list-inside">
            ...
            <li>
              ...
              your consent at any time where ZapStream relied on your consent to
          ...
          <ul className="list-disc list-inside">
            <li>By email: privacy@ZapStream.com</li>
          </ul>
        </div>
      </div>
      <Footer />
