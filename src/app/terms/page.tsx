    ...
    <main className="flex flex-col items-center justify-center mt-20">
      ...
      <div className="w-full max-w-6xl p-8">
        ...
        <div className="prose lg:prose-xl">
          ...
          <p>Welcome to ZapStream!</p>
          <p>
            These terms and conditions outline the rules and regulations for the
            use of ZapStream&apos;s Website, located at
            https://jj-ZapStream.vercel.app.
          </p>
          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use ZapStream if you do not agree to
            take all of the terms and conditions stated on this page.
          </p>

          <h2 className="text-2xl font-semibold mt-8">Cookies</h2>
          <p>
            We employ the use of cookies. By accessing ZapStream, you agreed to
            use cookies in agreement with the ZapStream&apos;s Privacy Policy.
          </p>
          <p>
          ...
          <p>
            Unless otherwise stated, ZapStream and/or its licensors own the
            intellectual property rights for all material on ZapStream. All
            intellectual property rights are reserved. You may access this from
            ZapStream for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>
          <p>You must not:</p>
          <ul className="list-disc list-inside">
            <li>Republish material from ZapStream</li>
            <li>Sell, rent, or sub-license material from ZapStream</li>
            <li>Reproduce, duplicate or copy material from ZapStream</li>
            <li>Redistribute content from ZapStream</li>
          </ul>
          ...
          <ul className="list-disc list-inside">
            <li>By email: support@ZapStream.com</li>
          </ul>
        </div>
      </div>
      <Footer />
