    ...
    <header className="fixed right-0 left-0 top-0 p-2 md:p-3 backdrop-blur-lg z-[100] flex items-center border-b-[1px] border-neutral-900 justify-between">
        ...
        <aside className="flex items-center gap-[1px]">
          ...
          <Image
            ...
            className="shadow-sm"
          />
          <p className="text-3xl font-bold">Stream</p>
        </aside>
      </Link>
      <nav className="hidden md:block">
        <ul className="flex items-center gap-6 list-none">
          <li>
            <Link className="hover:text-gray-300 dark:hover:text-gray-300" href="/products">Products</Link>
          </li>
          <li>
            <Link className="hover:text-gray-300 dark:hover:text-gray-300" href="/pricing">Pricing</Link>
          </li>
          <li>
            <Link className="hover:text-gray-300 dark:hover:text-gray-300" href="/clients">Clients</Link>
          </li>
          <li>
            <Link className="hover:text-gray-300 dark:hover:text-gray-300" href="/resources">Resources</Link>
          </li>
          <li>
            <Link className="hover:text-gray-300 dark:hover:text-gray-300" href="/documentation">Documentation</Link>
          </li>
          <li>
            <Link className="hover:text-gray-300 dark:hover:text-gray-300" href="/enterprise">Enterprise</Link>
          </li>
        </ul>
      </nav>
